...
#include <libsnark/zk_proof_systems/ppzksnark/snark_friendly_enc/r1cs_gg_ppzksnark_params.hpp>
...
public:
    ...
    accumulation_vector<libff::G2<ppT> > gamma_ABC_g2;
    ...
    r1cs_gg_ppzksnark_verification_key(const libff::GT<ppT> &alpha_g1_beta_g2,
                                       ...
                                       const accumulation_vector<libff::G2<ppT> > &gamma_ABC_g2) :
        alpha_g1_beta_g2(alpha_g1_beta_g2),
        gamma_g2(gamma_g2),
        delta_g2(delta_g2),
        gamma_ABC_g1(gamma_ABC_g1),
        gamma_ABC_g2(gamma_ABC_g2)
    {};
    ...
    size_t size_in_bits() const
    {
        ...
        return (gamma_ABC_g1.size_in_bits() + 2 * libff::G2<ppT>::size_in_bits()) + (gamma_ABC_g2.size_in_bits());
    }
...
#include <libsnark/zk_proof_systems/ppzksnark/snark_friendly_enc/r1cs_gg_ppzksnark.tcc>
