...
bool run_r1cs_gg_ppzksnark(const r1cs_example<libff::Fr<ppT> > &example,
                        const bool test_serialization, int mode, int msg, std::string public_e);

} // libsnark

#include <libsnark/zk_proof_systems/ppzksnark/voting_snark/examples/run_r1cs_gg_ppzksnark.tcc>
