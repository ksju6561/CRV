...
public class SimpleCircuitGenerator_vote_ajitai extends CircuitGenerator {
	...
	public SimpleCircuitGenerator_vote_ajitai(String circuitName, int treeHeight) {
		super(circuitName);
	...
	public static void main(String[] args) throws Exception {
		...
		SimpleCircuitGenerator_vote_ajitai generator = new SimpleCircuitGenerator_vote_ajitai("voting_ajitai64",16);
