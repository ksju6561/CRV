...
public class MerkleTreePathGadgetMakeTree_ajtaiInput{
	...
	public MerkleTreePathGadgetMakeTree_ajtaiInput(BigInteger leafNodeNum, int leafWordBitWidth, int leafNumOfWords, int treeHeight,String PKid_FileName) {
	...
	private void makeTree() {
		...
		try{
			...
			while((line = bufferedReader.readLine()) != null){
				BigInteger[] leafNodeBigInteger = new BigInteger[3];
				leafNodeBigInteger[0] = new BigInteger(line);
				leafNodeBigInteger[1] = new BigInteger(bufferedReader.readLine());
				leafNodeBigInteger[2] = new BigInteger(bufferedReader.readLine());

				System.out.print(leafNodeBigInteger[0] + " ");
				System.out.print(leafNodeBigInteger[1] + " ");
				System.out.println(leafNodeBigInteger[2]);

				BigInteger[] leafNodeBits = myMath.getBitArray(leafNodeBigInteger,Config.LOG2_FIELD_PRIME);
	...
	public static void main(String[] args) throws Exception{
		MerkleTreePathGadgetMakeTree_ajtaiInput makeTree = new MerkleTreePathGadgetMakeTree_ajtaiInput(new BigInteger("8"), 32, 8, 4,
				"/home/jk/workspace/jsnark/JsnarkCircuitBuilder/PKlist.dat");
		makeTree.printTree(new BigInteger("1"),0);
		makeTree.writeFile("/home/jk/workspace/jsnark/JsnarkCircuitBuilder/HashTree.dat");
	}
